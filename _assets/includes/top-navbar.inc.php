	...
	<div class="navbar-wrapper">
		<div class="navbar-header">
			<ul class="nav navbar-nav">
				...
				<li class="nav-item">
					<a href="./" class="navbar-brand nav-link"><img alt="branding logo" src="_assets/img/brand/logo.png" data-expand="_assets/img/brand/logo.png" data-collapse="_assets/img/brand/logo_icon.png" width="180" class="brand-logo"></a>
				</li>
		...
		<div class="navbar-container content container-fluid">
			<div id="navbar-mobile" class="collapse navbar-toggleable-sm">
				<ul class="nav navbar-nav">
					...
					<!-- <li class="nav-item hidden-sm-down"><a href="#" target="_blank" class="btn btn-success upgrade-to-pro">Upgrade to PRO $24</a></li> -->
				</ul>
				...
				<li class="dropdown dropdown-notification nav-item"><a href="#" data-toggle="dropdown" class="nav-link nav-link-label"><i class="ficon icon-mail6"></i><span class="tag tag-pill tag-default tag-info tag-default tag-up">8</span></a>
					<ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
						...
						<li class="list-group scrollable-container"><a href="javascript:void(0)" class="list-group-item">
							...
							<a href="javascript:void(0)" class="list-group-item">
								<div class="media">
									<div class="media-left"><span class="avatar avatar-sm avatar-away rounded-circle"><img src="./_assets/img/users/default.jpg" alt="avatar"><i></i></span></div>
									<div class="media-body">
				...
				<li class="dropdown dropdown-user nav-item"><a href="#" data-toggle="dropdown" class="dropdown-toggle nav-link dropdown-user-link"><span class="avatar avatar-online"><?php if($get_user['profile_pic']){ print '<img src="./_assets/img/users/'.$get_user['profile_pic'].'" alt="avatar">'; }else{ print '<img src="./_assets/img/users/default.jpg" alt="avatar">'; } ?><i></i></span><span class="user-name"><?php print $get_user['name'].' '.substr($get_user['lastname'], 0, 1). '...';?></span></a>
					<div class="dropdown-menu dropdown-menu-right">
						<a href="profile.php?user_id=<?php print $get_user['user_id']; ?>" class="dropdown-item"><i class="icon-head"></i> Editar Mi Perfil</a>
						<a href="#" class="dropdown-item"><i class="icon-mail6"></i> Mis Mensajes</a>
						<a href="#" class="dropdown-item"><i class="icon-clipboard2"></i> Cosas Por Hacer</a>
						<a href="#" class="dropdown-item"><i class="icon-calendar5"></i> Calendario</a>
						<div class="dropdown-divider"></div>
						<a href="?logout=1" class="dropdown-item"><i class="icon-power3"></i> Cerrar Sesión</a>
					</div>
				</li>
				</ul>
			</div>
